<%@ Page Title="MessageTemplate" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebDemo.Web.WebDemo.MessageTemplate.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="MessageID" HeaderText="MessageID" SortExpression="MessageID" ItemStyle-HorizontalAlign="Center"  /> 
