...
namespace WebDemo.DAL.WebDemo
{
	...
	public partial class BlanceAccount
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "BlanceAccount"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from BlanceAccount");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from BlanceAccount ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,BlanceDate,FailUserCode,Fail,AllCount,AllMoney,RefundMoney,BlanceTime ");
			strSql.Append(" FROM BlanceAccount ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,BlanceDate,FailUserCode,Fail,AllCount,AllMoney,RefundMoney,BlanceTime ");
			strSql.Append(" FROM BlanceAccount ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from BlanceAccount T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "BlanceAccount";
