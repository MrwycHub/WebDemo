...
namespace WebDemo.DAL.WebDemo
{
	...
	public partial class UpConsume
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("UpId", "UpConsume"); 
		}
		...
		public bool Exists(int UpId)
		{
			...
			strSql.Append("select count(1) from UpConsume");
		...
		public bool Delete(int UpId)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from UpConsume ");
			strSql.Append(" where UpId=@UpId");
			SqlParameter[] parameters = {
					new SqlParameter("@UpId", SqlDbType.Int,4)
			};
		...
		public bool DeleteList(string UpIdlist )
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from UpConsume ");
			strSql.Append(" where UpId in ("+UpIdlist + ")  ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select UpId,CardId,LostFreeNum,SurplusMoney,ConsumeTime,Meterid,UseMoney,InsDate ");
			strSql.Append(" FROM UpConsume ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" UpId,CardId,LostFreeNum,SurplusMoney,ConsumeTime,Meterid,UseMoney,InsDate ");
			strSql.Append(" FROM UpConsume ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			{
				strSql.Append("order by T.UpId desc");
			}
			strSql.Append(")AS Row, T.*  from UpConsume T ");
