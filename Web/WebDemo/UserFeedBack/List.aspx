<%@ Page Title="UserFeedBack" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebDemo.Web.WebDemo.UserFeedBack.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="ContactWay" HeaderText="ContactWay" SortExpression="ContactWay" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="ReplyMan" HeaderText="ReplyMan" SortExpression="ReplyMan" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="ReplyFlag" HeaderText="ReplyFlag" SortExpression="ReplyFlag" ItemStyle-HorizontalAlign="Center"  /> 
