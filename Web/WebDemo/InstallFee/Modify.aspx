<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="WebDemo.Web.WebDemo.InstallFee.Modify" Title="修改页" %>
...
<table cellSpacing="0" cellPadding="0" width="100%" border="0">
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtSingleFee" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		SumFee
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtSumFee" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		OperDate
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtInstallMark" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
</table>
