<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="WebDemo.Web.WebDemo.EInvoices.Modify" Title="修改页" %>
...
<table cellSpacing="0" cellPadding="0" width="100%" border="0">
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtInvoiceNumber" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		OrderNo
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtInvoiceState" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		OperDate
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtRtnInvoiceNumber" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		ManualRegist
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtManualRegist" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		RedSaleURL
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtRedSaleURL" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		RSInvoiceNumber
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtRSInvoiceNumber" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		RegistDate
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox ID="txtRegistDate" runat="server" Width="70px"  onfocus="setday(this)"></asp:TextBox>
	</td></tr>
</table>
