<%@ Page Title="Operation" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebDemo.Web.WebDemo.Operation.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="PayID" HeaderText="缴费ID" SortExpression="PayID" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="BeginMonth" HeaderText="起始月份" SortExpression="BeginMonth" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="BeginNumber" HeaderText="起始读数" SortExpression="BeginNumber" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="EndMonth" HeaderText="终止月份" SortExpression="EndMonth" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="EndNumber" HeaderText="终止读数" SortExpression="EndNumber" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="UseNumber" HeaderText="周期用量" SortExpression="UseNumber" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="Price2" HeaderText="单价" SortExpression="Price2" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="Price3" HeaderText="单价" SortExpression="Price3" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="FareMoney" HeaderText="费用" SortExpression="FareMoney" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="PayMark" HeaderText="缴费标志" SortExpression="PayMark" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="OperType" HeaderText="业务类型(1-抄表结算；2-换表结算" SortExpression="OperType" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="Derateid" HeaderText="Derateid" SortExpression="Derateid" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="FareName" HeaderText="FareName" SortExpression="FareName" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="OperationName" HeaderText="OperationName" SortExpression="OperationName" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="DerateReason" HeaderText="DerateReason" SortExpression="DerateReason" ItemStyle-HorizontalAlign="Center"  /> 
