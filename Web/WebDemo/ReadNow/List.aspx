<%@ Page Title="ReadNow" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebDemo.Web.WebDemo.ReadNow.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="ReadNumber" HeaderText="当前读数" SortExpression="ReadNumber" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="ValveState" HeaderText="阀门状态(1-开阀；2-关阀；" SortExpression="ValveState" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="AttackState" HeaderText="攻击状态(1-正常；2-被攻击" SortExpression="AttackState" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="Voltage" HeaderText="电压" SortExpression="Voltage" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="ReadDate" HeaderText="抄表时间" SortExpression="ReadDate" ItemStyle-HorizontalAlign="Center"  /> 
