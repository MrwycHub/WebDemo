...
{
	/// <summary>
	/// 数据访问类:MeterImageDataLog
	/// </summary>
	public partial class MeterImageDataLog
	{
		public MeterImageDataLog()
		{}
		#region  BasicMethod
		...
		/// 增加一条数据
		/// </summary>
		public int Add(WebDemo.Model.WebDemo.MeterImageDataLog model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into MeterImageDataLog(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(WebDemo.Model.WebDemo.MeterImageDataLog model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update MeterImageDataLog set ");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from MeterImageDataLog ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public WebDemo.Model.WebDemo.MeterImageDataLog GetModel(int ID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,MeterID,ReadTime,Voltage,ValveState,LowVoltage,MagneticDisturb,ImageQuality,EnableUpload,MeterImage,InsertDate,FreezeNumber,LeftMeterImage,RightMeterImage from MeterImageDataLog ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public WebDemo.Model.WebDemo.MeterImageDataLog DataRowToModel(DataRow row)
		{
			WebDemo.Model.WebDemo.MeterImageDataLog model=new WebDemo.Model.WebDemo.MeterImageDataLog();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM MeterImageDataLog ");
			if(strWhere.Trim()!="")
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM MeterImageDataLog ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from MeterImageDataLog T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "MeterImageDataLog";
