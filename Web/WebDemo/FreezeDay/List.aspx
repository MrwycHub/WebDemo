<%@ Page Title="FreezeDay" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebDemo.Web.WebDemo.FreezeDay.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="UploadFlag" HeaderText="UploadFlag" SortExpression="UploadFlag" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="ReadMode" HeaderText="ReadMode" SortExpression="ReadMode" ItemStyle-HorizontalAlign="Center"  /> 
