<%@ Page Title="MultiUser" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebDemo.Web.WebDemo.MultiUser.List" %>
...
<!--Title -->
            ...
            <asp:GridView ID="gridView" runat="server" AllowPaging="True" Width="100%" CellPadding="3"  OnPageIndexChanging ="gridView_PageIndexChanging"
                    BorderWidth="1px" DataKeyNames="MultiUserID" OnRowDataBound="gridView_RowDataBound"
		...
		<asp:BoundField DataField="CardSn" HeaderText="CardSn" SortExpression="CardSn" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="uAccount" HeaderText="uAccount" SortExpression="uAccount" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="OpenTime" HeaderText="OpenTime" SortExpression="OpenTime" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="ValidDate" HeaderText="ValidDate" SortExpression="ValidDate" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="LastMoney" HeaderText="LastMoney" SortExpression="LastMoney" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="ReMark" HeaderText="ReMark" SortExpression="ReMark" ItemStyle-HorizontalAlign="Center"  /> 
                            ...
                            <asp:HyperLinkField HeaderText="详细" ControlStyle-Width="50" DataNavigateUrlFields="MultiUserID" DataNavigateUrlFormatString="Show.aspx?id={0}"
                                Text="详细"  />
                            <asp:HyperLinkField HeaderText="编辑" ControlStyle-Width="50" DataNavigateUrlFields="MultiUserID" DataNavigateUrlFormatString="Modify.aspx?id={0}"
                                Text="编辑"  />
