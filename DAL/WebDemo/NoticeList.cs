...
namespace WebDemo.DAL.WebDemo
{
	...
	public partial class NoticeList
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "NoticeList"); 
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,NoticeTitle,NoticeInfo,NoticeDate,Author,ShowType ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,NoticeTitle,NoticeInfo,NoticeDate,Author,ShowType ");
			strSql.Append(" FROM NoticeList ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
