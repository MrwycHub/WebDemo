...
namespace WebDemo.DAL.WebDemo
{
	...
	public partial class OperMenuSet
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("OperatorID", "OperMenuSet"); 
		}
		...
		public bool Exists(int OperatorID,int MenuID)
		{
			...
			strSql.Append("select count(1) from OperMenuSet");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into OperMenuSet(");
			strSql.Append("OperatorID,MenuID,OrderNo,Flag)");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update OperMenuSet set ");
		...
		public bool Delete(int OperatorID,int MenuID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from OperMenuSet ");
			strSql.Append(" where OperatorID=@OperatorID and MenuID=@MenuID ");
			SqlParameter[] parameters = {
					new SqlParameter("@OperatorID", SqlDbType.Int,4),
					new SqlParameter("@MenuID", SqlDbType.Int,4)			};
		...
		public WebDemo.Model.WebDemo.OperMenuSet GetModel(int OperatorID,int MenuID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 OperatorID,MenuID,OrderNo,Flag from OperMenuSet ");
			strSql.Append(" where OperatorID=@OperatorID and MenuID=@MenuID ");
			SqlParameter[] parameters = {
					new SqlParameter("@OperatorID", SqlDbType.Int,4),
					new SqlParameter("@MenuID", SqlDbType.Int,4)			};
		...
		/// 得到一个对象实体
		/// </summary>
		public WebDemo.Model.WebDemo.OperMenuSet DataRowToModel(DataRow row)
		{
			WebDemo.Model.WebDemo.OperMenuSet model=new WebDemo.Model.WebDemo.OperMenuSet();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select OperatorID,MenuID,OrderNo,Flag ");
			strSql.Append(" FROM OperMenuSet ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from OperMenuSet T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "OperMenuSet";
			parameters[1].Value = "MenuID";
