<%@ Page Title="OperationTotal" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebDemo.Web.WebDemo.OperationTotal.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="FareMoney" HeaderText="总金额" SortExpression="FareMoney" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="PayMark" HeaderText="PayMark" SortExpression="PayMark" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="OperType" HeaderText="1-抄表结算；2-换表结算；" SortExpression="OperType" ItemStyle-HorizontalAlign="Center"  /> 
