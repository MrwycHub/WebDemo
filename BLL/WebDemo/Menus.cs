...
namespace WebDemo.BLL.WebDemo
{
	...
	{
		private readonly WebDemo.DAL.WebDemo.Menus dal=new WebDemo.DAL.WebDemo.Menus();
		public Menus()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public WebDemo.Model.WebDemo.Menus GetModelByCache(int MenuID)
		{
			
			string CacheKey = "MenusModel-" + MenuID;
			...
			return (WebDemo.Model.WebDemo.Menus)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<WebDemo.Model.WebDemo.Menus> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<WebDemo.Model.WebDemo.Menus> DataTableToList(DataTable dt)
		{
			List<WebDemo.Model.WebDemo.Menus> modelList = new List<WebDemo.Model.WebDemo.Menus>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				WebDemo.Model.WebDemo.Menus model;
