...
namespace WebDemo.DAL.WebDemo
{
	...
	public partial class CommandType
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("CommandID", "CommandType"); 
		}
		...
		public bool Exists(int CommandID)
		{
			...
			strSql.Append("select count(1) from CommandType");
		...
		public bool Delete(int CommandID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from CommandType ");
			strSql.Append(" where CommandID=@CommandID ");
			SqlParameter[] parameters = {
					new SqlParameter("@CommandID", SqlDbType.Int,4)			};
			parameters[0].Value = CommandID;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select CommandID,CommandName,Flag ");
			strSql.Append(" FROM CommandType ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from CommandType T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "CommandType";
