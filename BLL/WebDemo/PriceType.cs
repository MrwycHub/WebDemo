...
namespace WebDemo.BLL.WebDemo
{
	...
	{
		private readonly WebDemo.DAL.WebDemo.PriceType dal=new WebDemo.DAL.WebDemo.PriceType();
		public PriceType()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public WebDemo.Model.WebDemo.PriceType GetModelByCache(int PriceTypeID)
		{
			
			string CacheKey = "PriceTypeModel-" + PriceTypeID;
			...
			return (WebDemo.Model.WebDemo.PriceType)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<WebDemo.Model.WebDemo.PriceType> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<WebDemo.Model.WebDemo.PriceType> DataTableToList(DataTable dt)
		{
			List<WebDemo.Model.WebDemo.PriceType> modelList = new List<WebDemo.Model.WebDemo.PriceType>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				WebDemo.Model.WebDemo.PriceType model;
