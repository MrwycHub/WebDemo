...
namespace WebDemo.DAL.WebDemo
{
	...
	public partial class UserRegist
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "UserRegist"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from UserRegist");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from UserRegist ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,RegistPhone,PassWord,IdentityCard,Flag,RegistName,HeadImgPath,UpdateTime,SecurityId,SecurityAnswer,RandomStr,AppType,PayIntegration,TotalMoney ");
			strSql.Append(" FROM UserRegist ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,RegistPhone,PassWord,IdentityCard,Flag,RegistName,HeadImgPath,UpdateTime,SecurityId,SecurityAnswer,RandomStr,AppType,PayIntegration,TotalMoney ");
			strSql.Append(" FROM UserRegist ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from UserRegist T ");
