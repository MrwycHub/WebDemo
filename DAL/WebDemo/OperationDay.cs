...
namespace WebDemo.DAL.WebDemo
{
	...
	public partial class OperationDay
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("OperID", "OperationDay"); 
		}
		...
		public bool Exists(DateTime OperDate,int OperID)
		{
			...
			strSql.Append("select count(1) from OperationDay");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(WebDemo.Model.WebDemo.OperationDay model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into OperationDay(");
			strSql.Append("MeterID,BeginMonth,BeginNumber,EndMonth,EndNumber,UseNumber,PriceTypeID,PriceTypeName,Price,Price2,Price3,FareMoney,PayMark,OperType,OperDate,OperatorID,opermonth,MeterNumber,Divid1,Divid2,UseNumber1,UseNumber2,UseNumber3,ExtData1,ExtData2)");
			strSql.Append(" values (");
			strSql.Append("@MeterID,@BeginMonth,@BeginNumber,@EndMonth,@EndNumber,@UseNumber,@PriceTypeID,@PriceTypeName,@Price,@Price2,@Price3,@FareMoney,@PayMark,@OperType,@OperDate,@OperatorID,@opermonth,@MeterNumber,@Divid1,@Divid2,@UseNumber1,@UseNumber2,@UseNumber3,@ExtData1,@ExtData2)");
			strSql.Append(";select @@IDENTITY");
			SqlParameter[] parameters = {
					new SqlParameter("@MeterID", SqlDbType.Int,4),
					new SqlParameter("@BeginMonth", SqlDbType.VarChar,10),
					new SqlParameter("@BeginNumber", SqlDbType.Decimal,9),
					new SqlParameter("@EndMonth", SqlDbType.VarChar,10),
					...
					new SqlParameter("@opermonth", SqlDbType.VarChar,10),
					new SqlParameter("@MeterNumber", SqlDbType.Decimal,9),
					...
					new SqlParameter("@ExtData1", SqlDbType.VarChar,50),
					new SqlParameter("@ExtData2", SqlDbType.VarChar,50)};
			parameters[0].Value = model.MeterID;
			parameters[1].Value = model.BeginMonth;
			parameters[2].Value = model.BeginNumber;
			parameters[3].Value = model.EndMonth;
			parameters[4].Value = model.EndNumber;
			parameters[5].Value = model.UseNumber;
			parameters[6].Value = model.PriceTypeID;
			parameters[7].Value = model.PriceTypeName;
			parameters[8].Value = model.Price;
			parameters[9].Value = model.Price2;
			parameters[10].Value = model.Price3;
			parameters[11].Value = model.FareMoney;
			parameters[12].Value = model.PayMark;
			parameters[13].Value = model.OperType;
			parameters[14].Value = model.OperDate;
			parameters[15].Value = model.OperatorID;
			parameters[16].Value = model.opermonth;
			parameters[17].Value = model.MeterNumber;
			parameters[18].Value = model.Divid1;
			parameters[19].Value = model.Divid2;
			parameters[20].Value = model.UseNumber1;
			parameters[21].Value = model.UseNumber2;
			parameters[22].Value = model.UseNumber3;
			parameters[23].Value = model.ExtData1;
			parameters[24].Value = model.ExtData2;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(WebDemo.Model.WebDemo.OperationDay model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update OperationDay set ");
			...
			strSql.Append("ExtData1=@ExtData1,");
			strSql.Append("ExtData2=@ExtData2");
			...
			parameters[15].Value = model.opermonth;
			parameters[16].Value = model.MeterNumber;
			parameters[17].Value = model.Divid1;
			parameters[18].Value = model.Divid2;
			parameters[19].Value = model.UseNumber1;
			parameters[20].Value = model.UseNumber2;
			parameters[21].Value = model.UseNumber3;
			parameters[22].Value = model.ExtData1;
			parameters[23].Value = model.ExtData2;
			parameters[24].Value = model.OperID;
			parameters[25].Value = model.OperDate;
		...
		public bool Delete(int OperID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from OperationDay ");
			strSql.Append(" where OperID=@OperID");
			SqlParameter[] parameters = {
					new SqlParameter("@OperID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public WebDemo.Model.WebDemo.OperationDay GetModel(int OperID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 OperID,MeterID,BeginMonth,BeginNumber,EndMonth,EndNumber,UseNumber,PriceTypeID,PriceTypeName,Price,Price2,Price3,FareMoney,PayMark,OperType,OperDate,OperatorID,opermonth,MeterNumber,Divid1,Divid2,UseNumber1,UseNumber2,UseNumber3,ExtData1,ExtData2 from OperationDay ");
			strSql.Append(" where OperID=@OperID");
			SqlParameter[] parameters = {
					new SqlParameter("@OperID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public WebDemo.Model.WebDemo.OperationDay DataRowToModel(DataRow row)
		{
			WebDemo.Model.WebDemo.OperationDay model=new WebDemo.Model.WebDemo.OperationDay();
			if (row != null)
			{
				...
				if(row["MeterNumber"]!=null && row["MeterNumber"].ToString()!="")
				{
					model.MeterNumber=decimal.Parse(row["MeterNumber"].ToString());
				}
				...
				if(row["ExtData1"]!=null)
				{
					model.ExtData1=row["ExtData1"].ToString();
				}
				if(row["ExtData2"]!=null)
				{
					model.ExtData2=row["ExtData2"].ToString();
				}
			}
			return model;
		}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select OperID,MeterID,BeginMonth,BeginNumber,EndMonth,EndNumber,UseNumber,PriceTypeID,PriceTypeName,Price,Price2,Price3,FareMoney,PayMark,OperType,OperDate,OperatorID,opermonth,MeterNumber,Divid1,Divid2,UseNumber1,UseNumber2,UseNumber3,ExtData1,ExtData2 ");
			strSql.Append(" FROM OperationDay ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" OperID,MeterID,BeginMonth,BeginNumber,EndMonth,EndNumber,UseNumber,PriceTypeID,PriceTypeName,Price,Price2,Price3,FareMoney,PayMark,OperType,OperDate,OperatorID,opermonth,MeterNumber,Divid1,Divid2,UseNumber1,UseNumber2,UseNumber3,ExtData1,ExtData2 ");
			strSql.Append(" FROM OperationDay ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from OperationDay T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "OperationDay";
			parameters[1].Value = "OperID";
