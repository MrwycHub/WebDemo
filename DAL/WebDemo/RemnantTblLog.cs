...
namespace WebDemo.DAL.WebDemo
{
	...
	public partial class RemnantTblLog
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "RemnantTblLog"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from RemnantTblLog");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into RemnantTblLog(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update RemnantTblLog set ");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from RemnantTblLog ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		public WebDemo.Model.WebDemo.RemnantTblLog GetModel(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,MeterID,Remnant,ReadDate,CollectorReadDate from RemnantTblLog ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public WebDemo.Model.WebDemo.RemnantTblLog DataRowToModel(DataRow row)
		{
			WebDemo.Model.WebDemo.RemnantTblLog model=new WebDemo.Model.WebDemo.RemnantTblLog();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM RemnantTblLog ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from RemnantTblLog T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "RemnantTblLog";
