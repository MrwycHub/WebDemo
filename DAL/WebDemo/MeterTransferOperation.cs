...
namespace WebDemo.DAL.WebDemo
{
	...
	public partial class MeterTransferOperation
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "MeterTransferOperation"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from MeterTransferOperation");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from MeterTransferOperation ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,MeterID,OldUserID,OldUserName,OldUserCode,OldLastReadNumber,OldUserReserve,NewUserID,NewUserName,NewUserCode,OperatorID,BeginDate,OperDateTime ");
			strSql.Append(" FROM MeterTransferOperation ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,MeterID,OldUserID,OldUserName,OldUserCode,OldLastReadNumber,OldUserReserve,NewUserID,NewUserName,NewUserCode,OperatorID,BeginDate,OperDateTime ");
			strSql.Append(" FROM MeterTransferOperation ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from MeterTransferOperation T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "MeterTransferOperation";
