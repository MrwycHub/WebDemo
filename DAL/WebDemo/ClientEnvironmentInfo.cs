...
namespace WebDemo.DAL.WebDemo
{
	...
	public partial class ClientEnvironmentInfo
	{
		...
		public bool Exists(string DanWeiName,string JiQiMa,DateTime CreateTime,long Id)
		{
			...
			strSql.Append("select count(1) from ClientEnvironmentInfo");
			strSql.Append(" where DanWeiName=@DanWeiName and JiQiMa=@JiQiMa and CreateTime=@CreateTime and Id=@Id ");
		...
		public bool Delete(long Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from ClientEnvironmentInfo ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,DanWeiName,JiQiMa,OperatorCode,IP,BrowserName,BrowerVersion,OSName,CreateTime ");
			strSql.Append(" FROM ClientEnvironmentInfo ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" Id,DanWeiName,JiQiMa,OperatorCode,IP,BrowserName,BrowerVersion,OSName,CreateTime ");
			strSql.Append(" FROM ClientEnvironmentInfo ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from ClientEnvironmentInfo T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "ClientEnvironmentInfo";
