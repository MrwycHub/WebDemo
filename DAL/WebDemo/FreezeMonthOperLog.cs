...
namespace WebDemo.DAL.WebDemo
{
	...
	public partial class FreezeMonthOperLog
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "FreezeMonthOperLog"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from FreezeMonthOperLog");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into FreezeMonthOperLog(");
			strSql.Append("MeterID,Type,FreezeMonth,Content,UpdateTime)");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from FreezeMonthOperLog ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public WebDemo.Model.WebDemo.FreezeMonthOperLog DataRowToModel(DataRow row)
		{
			WebDemo.Model.WebDemo.FreezeMonthOperLog model=new WebDemo.Model.WebDemo.FreezeMonthOperLog();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ID,MeterID,Type,FreezeMonth,Content,UpdateTime ");
			strSql.Append(" FROM FreezeMonthOperLog ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,MeterID,Type,FreezeMonth,Content,UpdateTime ");
			strSql.Append(" FROM FreezeMonthOperLog ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from FreezeMonthOperLog T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "FreezeMonthOperLog";
