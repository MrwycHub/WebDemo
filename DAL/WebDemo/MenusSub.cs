...
namespace WebDemo.DAL.WebDemo
{
	...
	public partial class MenusSub
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("MenuID", "MenusSub"); 
		}
		...
		public bool Exists(int MenuID)
		{
			...
			strSql.Append("select count(1) from MenusSub");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into MenusSub(");
			strSql.Append("MenuID,UpperID,MenuName,UrlAddr,UrlTarget,ImageUrl,Flag,Ordernum,SystemNum)");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update MenusSub set ");
		...
		public bool Delete(int MenuID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from MenusSub ");
			strSql.Append(" where MenuID=@MenuID ");
			SqlParameter[] parameters = {
					new SqlParameter("@MenuID", SqlDbType.Int,4)			};
			parameters[0].Value = MenuID;
		...
		public WebDemo.Model.WebDemo.MenusSub GetModel(int MenuID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 MenuID,UpperID,MenuName,UrlAddr,UrlTarget,ImageUrl,Flag,Ordernum,SystemNum from MenusSub ");
			strSql.Append(" where MenuID=@MenuID ");
			SqlParameter[] parameters = {
					new SqlParameter("@MenuID", SqlDbType.Int,4)			};
			parameters[0].Value = MenuID;
		...
		/// 得到一个对象实体
		/// </summary>
		public WebDemo.Model.WebDemo.MenusSub DataRowToModel(DataRow row)
		{
			WebDemo.Model.WebDemo.MenusSub model=new WebDemo.Model.WebDemo.MenusSub();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select MenuID,UpperID,MenuName,UrlAddr,UrlTarget,ImageUrl,Flag,Ordernum,SystemNum ");
			strSql.Append(" FROM MenusSub ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from MenusSub T ");
