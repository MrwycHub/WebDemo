<%@ Page Title="FailureMessage" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebDemo.Web.WebDemo.FailureMessage.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="FailID" HeaderText="FailID" SortExpression="FailID" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="Pattern" HeaderText="Pattern" SortExpression="Pattern" ItemStyle-HorizontalAlign="Center"  /> 
