...
namespace WebDemo.DAL.WebDemo
{
	...
	public partial class ManageFare
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ManageFareID", "ManageFare"); 
		}
		...
		public bool Exists(int ManageFareID)
		{
			...
			strSql.Append("select count(1) from ManageFare");
		...
		public bool Delete(int ManageFareID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from ManageFare ");
			strSql.Append(" where ManageFareID=@ManageFareID");
			SqlParameter[] parameters = {
					new SqlParameter("@ManageFareID", SqlDbType.Int,4)
			};
		...
		public bool DeleteList(string ManageFareIDlist )
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from ManageFare ");
			strSql.Append(" where ManageFareID in ("+ManageFareIDlist + ")  ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ManageFareID,ManageFareName,ManageFarePrice,ManageFareTypeID,ReMark,SystemNum ");
			strSql.Append(" FROM ManageFare ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ManageFareID,ManageFareName,ManageFarePrice,ManageFareTypeID,ReMark,SystemNum ");
			strSql.Append(" FROM ManageFare ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from ManageFare T ");
