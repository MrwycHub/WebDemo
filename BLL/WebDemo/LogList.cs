...
namespace WebDemo.BLL.WebDemo
{
	...
	{
		private readonly WebDemo.DAL.WebDemo.LogList dal=new WebDemo.DAL.WebDemo.LogList();
		public LogList()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public WebDemo.Model.WebDemo.LogList GetModelByCache(int LogID)
		{
			
			string CacheKey = "LogListModel-" + LogID;
			...
			return (WebDemo.Model.WebDemo.LogList)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<WebDemo.Model.WebDemo.LogList> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<WebDemo.Model.WebDemo.LogList> DataTableToList(DataTable dt)
		{
			List<WebDemo.Model.WebDemo.LogList> modelList = new List<WebDemo.Model.WebDemo.LogList>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				WebDemo.Model.WebDemo.LogList model;
