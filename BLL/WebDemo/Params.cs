...
namespace WebDemo.BLL.WebDemo
{
	...
	{
		private readonly WebDemo.DAL.WebDemo.Params dal=new WebDemo.DAL.WebDemo.Params();
		public Params()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public WebDemo.Model.WebDemo.Params GetModelByCache(int ParamID)
		{
			
			string CacheKey = "ParamsModel-" + ParamID;
			...
			return (WebDemo.Model.WebDemo.Params)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<WebDemo.Model.WebDemo.Params> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<WebDemo.Model.WebDemo.Params> DataTableToList(DataTable dt)
		{
			List<WebDemo.Model.WebDemo.Params> modelList = new List<WebDemo.Model.WebDemo.Params>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				WebDemo.Model.WebDemo.Params model;
