<%@ Page Title="FreezeDayDosage" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebDemo.Web.WebDemo.FreezeDayDosage.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="DosageType" HeaderText="DosageType" SortExpression="DosageType" ItemStyle-HorizontalAlign="Center"  /> 
