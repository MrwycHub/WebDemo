<%@ Page Title="ManagePay" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebDemo.Web.WebDemo.ManagePay.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="ThisReserve" HeaderText="ThisReserve" SortExpression="ThisReserve" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="LastReserve" HeaderText="LastReserve" SortExpression="LastReserve" ItemStyle-HorizontalAlign="Center"  /> 
