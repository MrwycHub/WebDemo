...
namespace WebDemo.DAL.WebDemo
{
	...
	public partial class CollectorWork
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("CollectorID", "CollectorWork"); 
		}
		...
		public bool Exists(int CollectorID,int WorkID)
		{
			...
			strSql.Append("select count(1) from CollectorWork");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into CollectorWork(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update CollectorWork set ");
		...
		public bool Delete(int CollectorID,int WorkID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from CollectorWork ");
			strSql.Append(" where CollectorID=@CollectorID and WorkID=@WorkID ");
			SqlParameter[] parameters = {
					new SqlParameter("@CollectorID", SqlDbType.Int,4),
					new SqlParameter("@WorkID", SqlDbType.Int,4)			};
		...
		public WebDemo.Model.WebDemo.CollectorWork GetModel(int CollectorID,int WorkID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 CollectorID,WorkID,WorkTime from CollectorWork ");
			strSql.Append(" where CollectorID=@CollectorID and WorkID=@WorkID ");
			SqlParameter[] parameters = {
					new SqlParameter("@CollectorID", SqlDbType.Int,4),
					new SqlParameter("@WorkID", SqlDbType.Int,4)			};
		...
		/// 得到一个对象实体
		/// </summary>
		public WebDemo.Model.WebDemo.CollectorWork DataRowToModel(DataRow row)
		{
			WebDemo.Model.WebDemo.CollectorWork model=new WebDemo.Model.WebDemo.CollectorWork();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM CollectorWork ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from CollectorWork T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "CollectorWork";
			parameters[1].Value = "WorkID";
