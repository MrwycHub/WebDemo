<%@ Page Title="FreezeMonthls" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebDemo.Web.WebDemo.FreezeMonthls.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="CalMark" HeaderText="CalMark" SortExpression="CalMark" ItemStyle-HorizontalAlign="Center"  /> 
