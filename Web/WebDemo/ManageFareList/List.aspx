<%@ Page Title="ManageFareList" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="WebDemo.Web.WebDemo.ManageFareList.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="ManageFareID" HeaderText="ManageFareID" SortExpression="ManageFareID" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="LastMonth" HeaderText="LastMonth" SortExpression="LastMonth" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="ThisMonth" HeaderText="ThisMonth" SortExpression="ThisMonth" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="RcvFareNum" HeaderText="RcvFareNum" SortExpression="RcvFareNum" ItemStyle-HorizontalAlign="Center"  /> 
